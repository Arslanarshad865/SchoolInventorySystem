...
class UserSignupStatus(models.Model):
    USER_ID = models.ForeignKey(Accounts, primary_key=True, on_delete=models.CASCADE)  # Unique user identifier
    STATUS_CHOICES = [
        ('pending', 'Pending'),
        ('approved', 'Approved'),
        ('rejected', 'Rejected')
...
class EquipmentInventory(models.Model):
    ID = models.ForeignKey(EquipmentDetails, primary_key=True, on_delete=models.CASCADE)  # Unique inventory identifier, also referencing EquipmentDetails
...
class ReservationStatus(models.Model):
    RESERVATION_ID = models.ForeignKey(Reservations, primary_key=True, on_delete=models.CASCADE)  # Unique reservation identifier, also the primary key
    STATUS_CHOICES = [
        ('pending', 'Pending'),
        ('approved', 'Approved'),
        ('rejected', 'Rejected')
